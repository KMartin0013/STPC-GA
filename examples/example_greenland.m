% EXAMPLE_GREENLAND  STPC-GA (Version 1) Greenland example.
%
...
%% Region
config.TH_ori        = 'greenland';
config.areaName      = config.TH_ori;
config.landOrOcean   = 'ice';
config.c11cmn        = [-84.5 86.5 -4.5 55.5];
...
config.resultRoot = fullfile(config.ifilesRoot, 'Results_STPCGA1_greenland');
config.figureRoot = fullfile(config.ifilesRoot, 'Figure_STPCGA1_greenland');
