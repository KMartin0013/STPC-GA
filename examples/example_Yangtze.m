% EXAMPLE_YANGTZE  STPC-GA (Version 1) Yangtze River Basin example.
%
...
%% Region
config.TH_ori        = 'yangtze';
config.areaName      = config.TH_ori;
config.landOrOcean   = 'land';
config.c11cmn        = [85.5 39.5 124.5 20.5];
...
config.resultRoot = fullfile(config.ifilesRoot, 'Results_STPCGA1_yangtze');
config.figureRoot = fullfile(config.ifilesRoot, 'Figure_STPCGA1_yangtze');
