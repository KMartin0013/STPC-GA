% EXAMPLE_MEKONG  STPC-GA (Version 1) Mekong example.
%
...
%% Region
config.TH_ori        = 'mekong';
config.areaName      = config.TH_ori;
config.landOrOcean   = 'land';
config.c11cmn        = [85.5 39.5 114.5 0.5];
...
config.resultRoot = fullfile(config.ifilesRoot, 'Results_STPCGA1_mekong');
config.figureRoot = fullfile(config.ifilesRoot, 'Figure_STPCGA1_mekong');
